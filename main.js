let products = JSON.parse(localStorage.getItem("products"))
  ...
  : [
    {
      title: "Nike",
      category: "Nike Air Max Pre-Day ",
      price: "2399.00 ",
      img: "https://i.postimg.cc/wjJf8xXX/Nike-Air-Max.webp",
    },
    {
      title: "adidas",
      category: "adidas Women's Forum Bold ",
      price: "199.00",
      img: "https://i.postimg.cc/R0MdH6Pv/Addida-women.webp",
    },
    {
      title: "Nike Jordan",
      category: "Jordan Max Aura 3",
      price: "2199.00 ",
      img: "https://i.postimg.cc/jdBd2ySJ/jordan-max-aura-3.jpg",
    },
    {
      title: "Nike",
      category: "Nike Women's Air Huarache ",
      price: "2199.00 ",
      img: "https://i.postimg.cc/mgcz6bt7/Nikes-women-Air.webp",
    },
...
function readProducts(products) {
  ...
  products.forEach((product, position) => {
    document.querySelector("#products").innerHTML += `
      ...
      <div
                class="modal fade" id="editProduct${position}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
              >
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="mb-3">
                        ...
                        <input class="form-control"type="text" name="editTitle${position}" id="editTitle${position}" value="${product.title}"
                        />
                      </div>
                      <div class="mb-3">
                        ...
                        >
                        <option value="Nike Air Max Pre-Day">Nike Air Max Pre-Day</option>
                        <option value="Adidas Women's Forum Bold">Adidas Women's Forum Bold</option>
                        <option value="Jordan Max Aura 3">Jordan Max Aura 3</option>
                        <option value="Nike Women's Air Huarache">Nike Women's Air Huarache</option> </select>
                        </select>
                      </div>
                      <div class="mb-3">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="updateProduct(${position})"
                      >
                        Save changes
                      </button>
                    </div>
...
function createProduct() {
  let title = document.querySelector("#addTitle").value.toLowerCase;
  let category = document.querySelector("#addCategory").value.toLowerCase;
...
function updateProduct(position) {
  ...
  try {
    if (!title || !price || !img) throw new Error("Please fill fields");
    products[position] = {
      title,
      category,
      price,
